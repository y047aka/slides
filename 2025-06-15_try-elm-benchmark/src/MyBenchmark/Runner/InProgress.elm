module MyBenchmark.Runner.InProgress exposing (Class, styles, view)

import Element exposing (..)
import Element.Attributes exposing (..)
import MyBenchmark.Reporting as Reporting exposing (Report(..))
import MyBenchmark.Runner.Box as Box
import MyBenchmark.Runner.Text as Text
import MyBenchmark.Status as Status exposing (Status(..))
